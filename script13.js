const questions13 = [
    ...
    hint: "data, phenomena, trivia, fungi, alumni, octopi, nuclei" }, {
    question: "ab-",
    answers : [
    ...
    hint: "abnormal, abjure, absent, abroad, abrupt, abduct" }, {
    question: "anti-",
    answers : [
    ...
    hint: "anti-aircraft, antibody, antitoxin, antithesis" }, {
    question: "-cy",
    answers : [
    ...
    hint: "urgency, diplomacy, legitimacy, regency" }, {
    question: "-en",
    answers : [
    ...
    hint: "strengthen, harden, lengthen, shorten, soften" },
    {question: "-ence / -ance",
    answers : [
        { text : "state or quality", correct: true },
    ...
    hint: "independence, compliance, emergence, alliance" }, {
    question: "-ics",
    answers : [
    ...
    hint: "politics, economics, aesthetics, graphics, ethics" }, {
    question: "-ine",
    answers : [
    ...
    hint: "saturnine, crystallines, canine, vulpine, bovine, ursine" }, {
    question: "-ism",
    answers : [
    ...
    hint: "Marxism, capitalism, Cubism, nihilism, pluralism" }, {
    question: "-ive",
    answers : [
    ...
    hint: "prospective, protective, suggestive, conclusive" },
    {question: "-like",
    answers : [
    ...
    hint: "ladylike, doglike, parent-like" }, {
    question: "-worthy",
    answers : [
    ...
    hint: "seaworthy, trustworthy, newsworthy, worthy" }, {
    ...
    hint: "circumnavigate, circumspect, circumvent, circus, circle" }, {
    question: "co- / com- / con-",
    answers : [
    ...
    hint: "combination, complete, contract, conjunction, cooperate, convivial" },
    {question: "de-",
    answers : [
    ...
    hint: "descend, denounce, demolish, deplete, dependent, defuse, delimit, delete?" }, {
    question: "dia-",
    answers : [
    ...
    hint: "diagonal, diameter, dialogue, dialect, diatribe, diaphanous" }, {
    question: "endo-",
    answers : [
    ...
    hint: "endocrine, endoskeleton, endothermic, endoplasm" }, {
    ...
    hint: "exit, excise, exotic, explicate, eccentric, efface, egress, ectothermic, ectoplasm" },
    {question: "holo-",
    answers : [
    ...
    hint: "holocaust, hologram, holograph, holistic" }, {
    question: "hyp-",
    answers : [
    ...
    hint: "hypodemic, hypothesis, hypotenuse, hypothermia" }, {
    question: "mal-",
    answers : [
    ...
    hint: "postgraduate, postscript, posterity, posterior, postlude, preposterous" },
    {question: "pro-",
    answers : [
    ...
    hint: "proceed, provide, pronoun, program, prospect, pro temp" }, {
    question: "sym- / syn-",
    answers : [
    ...
    hint: "sympathy, symmetry, symphony, synchronize, synonym" }, {
    ...
    hint: "ultramarine, ultraconservative, ultraviolet, ultramundane, ulterior" }
]
...
function showScore() {
    ...
    nextList.addEventListener("click", () => { window.location.href ="https://stems-list.onrender.com/list14.html"; });
